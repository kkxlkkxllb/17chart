...
(function() {
  ...
  Package = (function() {
    function Package(name, config, argv) {
      ...
      this.afters = toArray(config.afters || []);
    ...
    Package.prototype.compileAfters = function() {
      var after;
      return ((function() {
        var _i, _len, _ref, _results;
        _ref = this.afters;
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          after = _ref[_i];
          _results.push(fs.readFileSync(after, 'utf8'));
        }
        return _results;
      }).call(this)).join("\n");
    };
    ...
    Package.prototype.compileJavascript = function(minify) {
      ...
      try {
        result = [this.compileLibs(), this.compileModules(), this.jsAfter, this.compileAfters()].join("\n");
        if (minify) {
